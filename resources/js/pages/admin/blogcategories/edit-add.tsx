...
export default function Create(props: BlogCategory) {
    ...
    const submit = (e: FormEvent) => {
        ...
        {
            props.model?.id ? post(route('blogcategories.update', [props.model?.id])) : post(route('blogcategories.store'));
        }
    };
                ...
                <div className="container">
                    <form onSubmit={submit}>
                        <div className="mb-4 flex flex-col gap-2">
                            <Input
                                type="text"
                                placeholder="BlogCategories Name"
                                value={data.title}
                                name="title"
