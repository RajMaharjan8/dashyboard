...
export default function List(props: ListProps) {
    ...
    const fetchData = async (page: number, searchTitle: string) => {
        setLoading(true);
        let url = route('blogcategories.paginate');
        try {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <div className="flex justify-between">
                    ...
                    <Link href={route('blogcategories.create')}>
                        <Button type="submit">Add New BlogCategories</Button>
                    </Link>
                </div>
                ...
                <Table>
                    <TableHeader>
                        <TableRow>
                            ...
                            <TableHead>BlogCategories Name</TableHead>
                            ...
                            data.map((item, index) => (
                                <TableRow key={item.id}>
                                    ...
                                    <TableCell className="text-right">
                                        <Link href={route('blogcategories.edit', { id: item.id })}>
