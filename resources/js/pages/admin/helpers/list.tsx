...
export default function List(props: ListProps) {
    ...
    const fetchData = async (page: number, searchTitle: string) => {
        setLoading(true);
        let url = route('helpers.paginate');
        try {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <div className="flex justify-between">
                    ...
                    <Link href={route('helpers.create')}>
                        <Button type="submit">Add New Helpers</Button>
                    </Link>
                </div>
                ...
                <Table>
                    <TableHeader>
                        <TableRow>
                            ...
                            <TableHead>Helpers Name</TableHead>
                            ...
                            data.map((item, index) => (
                                <TableRow key={item.id}>
                                    ...
                                    <TableCell className="text-right">
                                        <Link href={route('helpers.edit', { id: item.id })}>
